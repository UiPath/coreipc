...
export class TimeSpan {
    ...
    public static toTimeSpan(arg0: number | TimeSpan): TimeSpan {
        if (arg0 == null) { throw new ArgumentNullError('arg0'); }

        let delay: TimeSpan;
        switch (typeof arg0) {
            default:
                throw new ArgumentError('Expecting either a number or a TimeSpan.', 'arg0');
            case 'number':
                delay = TimeSpan.fromMilliseconds(arg0);
                break;
            case 'object':
