...
export namespace Contract {
    ...
    export class IAgentEvents {
        public OnJobCompleted(args: JobCompletedEventArgs): Promise<void> { throw null; }
        public OnJobStatusUpdated(args: JobStatusChangedEventArgs): Promise<void> { throw null; }
        public OnOrchestratorStatusChanged(args: OrchestratorStatusChangedEventArgs): Promise<void> { throw null; }
        public OnLogInSessionExpired(message: Message<void>) { throw null; }
    }
}
