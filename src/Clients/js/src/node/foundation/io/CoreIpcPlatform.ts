...
import { NamedPipeSocketAddress } from '.';
import { NamedPipeClientSocket } from '.';
import { Timeout, CancellationToken } from '@foundation';
        ...
        public async pipeExists(shortName: string): Promise<boolean> {
            ...
            try {
                socket = await NamedPipeClientSocket.connect(
                    new NamedPipeSocketAddress(shortName),
