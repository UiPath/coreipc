...
namespace UiPath.CoreIpc.Tests
{
    class Program
    {
        ...
        private static async Task RunTestsAsync(CancellationToken cancellationToken)
        {
            ...
            var computingClientBuilder = new NamedPipeClientBuilder<IComputingService, IComputingCallback>("computingPipe", serviceProvider).AllowImpersonation().RequestTimeout(TimeSpan.FromSeconds(2));
